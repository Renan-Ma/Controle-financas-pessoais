...
userRouter.get("/getExpense", financeController.getExpense)
userRouter.put("/expense/:id", financeController.updateExpense)
userRouter.delete("/expense/:id", financeController.deleteExpense)
